...
if (isset($_GET['archives']) && ($archives = $_GET['archives'])!='') {
  ...
  $wpmp_title = __("We couldn't find an exact match. Please visit our Help Desk and submit a ticket;  or view or Full-Site, the next time you're on a desktop. Thanks!", 'wpmp');
print "<p>$wpmp_title</p>";
  $wpmp_not_found = true;
}


print "<div id='wrapper'><div id='content'>";
if ($wpmp_title!='' && !$wpmp_not_found) {

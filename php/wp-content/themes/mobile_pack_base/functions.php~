...
function base_func(  ){
$base=get_theme_root_uri();
$link = "<div class='fp-slider clearfix'>    
    <div class='fp-slides-container clearfix'>        
        <div class='fp-slides'>
   <div class='fp-slides-items'>                    
                        <div class='fp-thumbnail'>
                            <a href='/cavi-lipo' title='Cavi'><img class='topicon1' src='$base/mobile_pack_base/img/cavi.png' /></a>  
                      </div>
</div>        
                            
                    <div class='fp-slides-items'>                    
                        <div class='fp-thumbnail'>
                            <a href='/facials' title='facials'><img class='topicon2' src='$base/mobile_pack_base/img/tuel.jpg' /></a>                        </div>                           
                                                
                    </div>   
                    <div class='fp-slides-items'>
                        <div class='fp-thumbnail'>
                            <a href='/chemical-peels' title='chemical-peels'><img class='topicon3' src='$base/mobile_pack_base/img/skincare.jpg' /></a>                        </div>     
                    </div>  
                    <div class='fp-slides-items'>
                    
                        <div class='fp-thumbnail'>
                            <a href='/depilar-system' title='depilar-system'><img class='topicon4' src='$base/mobile_pack_base/img/depliar.png' /></a>                        </div>
        </div>     
        </div>
...
function let_rendezvous(){
$base=get_theme_root_uri();
$link_uri="<div class='lets'><a href='https://clients.mindbodyonline.com/ASP/home.asp?studioid=33113' target='_blank'><img class='lets-image' src='$base/mobile_pack_base/img/lets-btn.png'/></a></div>";
return $link_uri;
}
function location(){
$base=get_theme_root_uri();
return "<script type='text/javascript' src='$base/mobile_pack_base/js/googlemap.js'></script>
...
add_shortcode( 'baseuri', 'base_func' );
add_shortcode( 'root_uri', 'get_theme_root_uri' );
add_shortcode( 'rendezvous', 'let_rendezvous' );
add_shortcode( 'location', 'location' );
add_shortcode( 'regform', 'regform' );
?>

...
if (file_exists($wpmp_include = wpmp_theme_group_file('header.php'))) {
  ...
  <head profile="http://gmpg.org/xfn/11">
    ...
    <link href="<?php print get_theme_root_uri(); ?>/mobile_pack_base/style_structure.css" rel="stylesheet" type="text/css" />      <script src="<?php print get_theme_root_uri(); ?>/mobile_pack_base/jquery/demos/js/jquery.js"></script>
    
<link href="<?php print get_theme_root_uri(); ?>/mobile_pack_base/box.css" rel="stylesheet" type="text/css" />
<link href="<?php print get_theme_root_uri(); ?>/mobile_pack_base/slide.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="<?php print get_theme_root_uri(); ?>/mobile_pack_base/js/googlemap.js"></script>
<script type="text/javascript" src="<?php print get_theme_root_uri(); ?>/mobile_pack_base/js/jquery.cycle.all.js"></script>
...
<div id="topnav">
 <div id="logs">
   <a href="/fhome"> <img class="headerlogo" src="<?php print get_theme_root_uri(); ?>/mobile_pack_base/img/logo.png" alt="facialsandwax"></a>
</div>
<div id="searchPath">
...
?>
<div class="back">
<a href="javascript:history.back()"> <img class="backlogo" src="<?php print get_theme_root_uri(); ?>/mobile_pack_base/img/back.png" alt="facialsandwax"></a>
</div>
<?php
}
?>
